...
- [ ] Проверка на стиль (Google C++ Style) и правка (до 29.10.23)
- [ ] Проверка статическим анализатором (cppcheck) и правка (до 30.10.23) 
- [x] Автоматизация сборки (CMake) (до 27.10.23)
- [ ] Автоматизация отрисовки графиков (скорее всего Python скрипт) (до 29.10.23)
- [x] Создание схемы с соответствием точек на I-Q графике с соответствующими кодами Грея (до 27.10.23)
